...
#define kHeader @"192.168.1.105/phpTest/videos"
...
- (void)viewDidLoad {
    ...
    //保存路径需要转换为url路径，才能播放
    NSString *urlStr = [NSString stringWithFormat:@"http://%@/%@",kHeader,self.videoName];
    //NSString *urlStr = [kHeader stringByAppendingPathComponent:self.videoName];
